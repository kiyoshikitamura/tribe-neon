...
const raidAcceptancePreview = process.env.VERCEL_ENV === "preview"
  && ["codex/formal-open-integration-preview-20260914", "feat/quest-progression-20260916", "feat/raid-ui-refresh-20260918"].includes(process.env.VERCEL_GIT_COMMIT_REF || "")
