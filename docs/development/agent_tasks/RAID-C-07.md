# RAID-C-07 — 旧経路分離・接続契約
TASK ID: RAID-C-07
OWNER: raid_c_phase7
PRIORITY: P1
STATUS: VALIDATED
SCOPE: tests/db/raid-room-legacy-isolation-* と docs/development/raid_room_phase7_validation.md。Aの実SQL00254をPGliteで実行しRoomに副作用なし・旧通常系維持を検証。fixture依存double明記。
