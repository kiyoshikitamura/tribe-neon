# RAID-B-16
TASK ID: RAID-B-16
OWNER: raid_b_phase16
PRIORITY: P1
STATUS: VALIDATED
SCOPE: src/domain/raidRoomClearReward.ts新規、src/app/components/raid/RaidRoomClearRewardPanel.tsx新規、RaidRoomBrowser.tsx/ConnectedBrowser.tsxへの接続、必要な既存CSSとphase16_ui.md専有。Aの本人readを表示、救援とは別ダイアログ項目、既存Present遷移再利用。型/APIをA/Cと調整。
