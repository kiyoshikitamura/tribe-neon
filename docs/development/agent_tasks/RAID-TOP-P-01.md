# RAID-TOP-P-01
TASK ID: RAID-TOP-P-01
OWNER: P
PRIORITY: P2
STATUS: VALIDATED (HUMAN_ACCEPTANCE未判定)
SCOPE: 契約・共有ファイル統合・最終レビュー・ローカルcommit。専有: src/domain/raidTop.ts, RaidRoomBrowser.tsx, RaidRoomConnectedBrowser.tsx, RaidRoomBrowser.css, RaidTab.css, raidRoomPresentation.ts, release_board.md
