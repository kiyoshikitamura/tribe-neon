# RAID-C-10 — 期限定期処理・未確定戦闘復帰
TASK ID: RAID-C-10
OWNER: raid_c_phase10
PRIORITY: P1
STATUS: VALIDATED
SCOPE: tests/db/phase10用fixture/runner/tests と tests/raid-room recovery/実useBattleテスト、raid_room_phase10_validation.mdのみ。A/B実装と独立して境界/権限/再送/再読込/保存失敗/旧経路回帰を検証。既存テスト編集専有。
