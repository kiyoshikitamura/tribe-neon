...
TASK ID: RAID-B-19
OWNER: raid_b_phase19
PRIORITY: P1
STATUS: VALIDATED
SCOPE: Room画面/専用Activity helper/hookとGameContextの開催通知接続、docs/development/raid_room_phase19_ui.md
...
ACCEPTANCE CRITERIA: 作成・Room再取得/戦闘復帰後に開催通知を更新。全体bootstrap再実行や恒常pollingを増やさない。account切替/古い応答混入/期限を扱う。共有stateはB専有。
