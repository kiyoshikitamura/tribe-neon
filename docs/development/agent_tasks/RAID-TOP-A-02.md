# RAID-TOP-A-02
TASK ID: RAID-TOP-A-02
OWNER: A
PRIORITY: P1
STATUS: VALIDATED
SCOPE: トップ集約SQL案のみ: docs/development/raid_top_step2_aggregate.sql（親統合用。正式migrationへ統合後、SQL案は保持しない）、raid_top_step2_api.md。migration編集/DB接続は禁止。
