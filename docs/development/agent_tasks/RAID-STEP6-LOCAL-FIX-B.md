TASK ID: RAID-STEP6-LOCAL-FIX-B
OWNER: raid_top_b
PRIORITY: P1
STATUS: VALIDATED
SCOPE: 保存Replay由来の背景統一。担当: src/hooks/useBattle.ts とReplay/presentation helper/専用test。GameContext/raid UI/SQLは触らない。
...
EXPECTED OUTPUT: 担当差分、docs/development/raid_step6_local_fix_b.md
