# RAID-C-13 — 救援報酬とPresent接続
TASK ID: RAID-C-13
OWNER: raid_c_phase13
PRIORITY: P1
STATUS: VALIDATED
SCOPE: tests配下SQL260 PGlite/既存Present受取実関数検証/救援報酬adapter/Reactとphase13_validation文書のみ。CLEAR時の他参加者付与、遅い確定、再送重複防止、未設定/未成功/期限と受取を検証。
