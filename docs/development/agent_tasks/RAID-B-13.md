# RAID-B-13 — 救援報酬とPresent接続
TASK ID: RAID-B-13
OWNER: raid_b_phase13
PRIORITY: P1
STATUS: VALIDATED
SCOPE: src内救援報酬domain/adapter/Room報酬ダイアログ/Present Box遷移専有、phase13_ui文書。サーバー判定/明細を表示し未設定を未獲得ゼロと混同しない。SQL/tests禁止。
