# RAID-TOP-B-01
TASK ID: RAID-TOP-B-01
OWNER: B
PRIORITY: P2
STATUS: VALIDATED (HUMAN_ACCEPTANCE未判定)
SCOPE: 表示データ接続と状態整理。専有: src/domain/raidTopData.ts, raidTopAssets.ts, src/app/components/raid/useRaidTop.ts, docs/development/raid_top_data_contract.md
