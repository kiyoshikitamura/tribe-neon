-- Parent review required; retains new objects and daily data. Default ROLLBACK.
begin;
...
ALTER FUNCTION public.create_raid_room_v1(text,text,uuid) OWNER TO postgres;
-- Saved original ACL: {postgres=X/postgres,authenticated=X/postgres}
...
ALTER FUNCTION public.list_raid_room_boss_choices_v1() OWNER TO postgres;
-- Saved original ACL: {postgres=X/postgres,authenticated=X/postgres}
