...
assert.ok(raidPortrait.indexOf("battle-unit-identity-badges") < raidPortrait.indexOf("<strong>{participant.name}</strong>"), "Raid attribute badge must precede the character name on both mirrored sides");
