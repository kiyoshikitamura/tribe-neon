...
client.setStorage("quests", [{ id: "QUEST_SHINJUKU_EASY", name: "歌舞伎町 夜間見回り", duration_seconds: 60, cost_vitality: 5, cash_reward: 1, exp_reward: 1 }]);
...
client.setStorage("user_main_formations", [{ user_id: userId, user_character_id: "owned-reiji", slot: 0 }]);
client.setStorage("user_patrols", [
  { id: "first", user_id: userId, course_id: "QUEST_SHINJUKU_EASY", status: "CLAIMABLE", expires_at: new Date(0).toISOString(), has_battle_event: false },
  { id: "battle", user_id: userId, course_id: "QUEST_SHINJUKU_EASY", character_id: "char_reiji_01", status: "CLAIMABLE", expires_at: new Date(0).toISOString(), has_battle_event: true, battle_resolved: false },
]);
...
try {
  ...
  patrols.push({ id: "repeat", user_id: userId, course_id: "QUEST_SHINJUKU_EASY", status: "CLAIMABLE", expires_at: new Date(0).toISOString(), has_battle_event: false });
