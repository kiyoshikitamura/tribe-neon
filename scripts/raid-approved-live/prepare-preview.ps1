...
$sourceSha = '59eea0414855bdadf36c8df4e30ad41ca10fa449'
$out = Join-Path $repo 'outputs/raid-approved-live'
$stage = Join-Path $out 'source-59eea04'
...
$archive = Join-Path $out 'source-59eea04.tar'
