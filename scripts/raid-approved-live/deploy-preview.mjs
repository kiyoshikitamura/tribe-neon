...
const root=path.resolve(import.meta.dirname,'../..'), out=path.join(root,'outputs/raid-approved-live');
const sourceSha='59eea0414855bdadf36c8df4e30ad41ca10fa449';
...
if(path.resolve(stage)!==path.join(out,'source-59eea04'))throw Error('Wrong staging path');
