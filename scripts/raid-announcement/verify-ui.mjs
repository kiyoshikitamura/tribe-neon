...
return <Context.Provider value={{showInboxPanel,setShowInboxPanel,newsList,setNewsList,inboxPanelTab,setInboxPanelTab,presents:[],markNewsRead:()=>{},playCyberSe:()=>{},presentClaimLoading:false}}>{children}</Context.Provider>;
}`;
