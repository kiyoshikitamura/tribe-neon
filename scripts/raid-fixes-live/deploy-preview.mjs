...
const root=path.resolve(import.meta.dirname,'../..'), out=path.join(root,'outputs/raid-fixes-live');
const sourceSha='b7e523b7c4651a8682f5e182733604e5e463316d';
...
if(path.resolve(stage)!==path.join(out,'source-b7e523b'))throw Error('Wrong staging path');
