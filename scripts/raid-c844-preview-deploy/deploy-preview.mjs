...
const root=path.resolve(import.meta.dirname,'../..'), out=path.join(root,'outputs/raid-c844-preview-deploy');
const sourceSha='c844534f5ce160fb3e713a58aed8377190aaa209';
...
if(path.resolve(stage)!==path.join(out,'source-c844534'))throw Error('Wrong staging path');
