...
const out=path.resolve('outputs/raid-c844-preview-deploy');const team='team_ounFOJd7sfCvcytYCkExbj77',project='prj_He8QAAwvfwm74FWq2Vb8BFHCbEXb';const json=p=>JSON.parse(fs.readFileSync(p,'utf8'));
