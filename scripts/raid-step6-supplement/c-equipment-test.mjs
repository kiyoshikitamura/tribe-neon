...
try{
 ...
 mkdirSync('outputs/raid-step6-supplement',{recursive:true});writeFileSync('outputs/raid-step6-supplement/c-equipment-local.json',JSON.stringify({engine:'PGlite in memory',results,externalExecuted:false,multiConnectionConcurrencyTested:false},null,2));
 writeFileSync('outputs/raid-step6-supplement/c-initializer-candidate.sql',initializer);
