...
const result=spawnSync(process.execPath,['--test','tests/db/raid-room-finalization.test.mjs'],{cwd:root,stdio:'inherit',env:{...process.env,RAID_TEST_RUNTIME:resolve(runtime)}});
