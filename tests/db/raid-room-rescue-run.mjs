...
const result=spawnSync(process.execPath,['--test','tests/db/raid-room-rescue.test.mjs'],{cwd:root,stdio:'inherit',env:{...process.env,RAID_TEST_RUNTIME:resolve(runtime)}});
