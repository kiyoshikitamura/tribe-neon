      ...
      if (questsData) {
        ...
        setPatrolCourses(questsData.map((quest: any) => {
          ...
          return {
            ...
            progression_boss_members: progressEnabled ? canonical?.progression_boss_members ?? [] : [],
            progression_recommended_power: progressEnabled ? canonical?.progression_recommended_power ?? null : null,
            progression_strategy_hint: progressEnabled ? canonical?.progression_strategy_hint ?? null : null,
