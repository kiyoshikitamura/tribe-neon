...
export default function StreetBattleSetup({playerParty,enemyParty,playerPower,enemyPower,tutorial,mode,label,background,tactic,onTactic,onStart,onBack,startLabel,backLabel,resourceLabel}:{playerParty:Member[];enemyParty:Member[];playerPower:number;enemyPower:number;tutorial:boolean;mode:string;label:string;background?:string;tactic:string;onTactic:(value:string)=>void;onStart:()=>void;onBack?:()=>void;startLabel?:string;backLabel?:string;resourceLabel?:string}) {
