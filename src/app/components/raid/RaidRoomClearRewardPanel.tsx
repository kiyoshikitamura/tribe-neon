...
export default function RaidRoomClearRewardPanel({ client, roomId, userId, onOpenPresents }: {
  client: RaidRoomClearRewardClient; roomId: string; userId?: string; onOpenPresents?: () => void | Promise<void>;
}) {
  ...
  return <div aria-label="討伐報酬">
    ...
    {reward && rewardIdentity === identity && <>
      ...
      <p className="raid-room-muted">Room終了後に確定した戦闘は討伐報酬の貢献に含みません。</p>
      <p className="raid-room-muted">討伐報酬は1人につきRoomごとに1回。送付から30日以内にプレゼントBOXで受け取れます。</p>
