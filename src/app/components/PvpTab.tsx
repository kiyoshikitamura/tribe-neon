...
export default function PvpTab() {
  ...
  const raidLeader = CHARACTERS_MASTER.find(character => character.id === "char_koharu_01");
  ...
  return (
    ...
    >
        ...
        <RaidEntryCard active={isRaidActive} bossName={raidBossName} seconds={raidBossSecondsLeft} image={raidImage} background={getCanonicalBattleBackground("yokohama")} onOpen={() => navigateTab("raid")} />
        <GuildBattleTeaser />
    </HubPage>
