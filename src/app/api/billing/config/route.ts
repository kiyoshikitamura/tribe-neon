...
import { catalogMatches, CATALOG_VERSION, UNRESOLVED_DIA_PRODUCTS } from "@/server/billing/catalog";
...
export async function GET() {
  try {
    ...
    return billingResponse({ available: true, mode: billing.config.mode, catalogVersion: CATALOG_VERSION, disabledProductIds: UNRESOLVED_DIA_PRODUCTS });
  }
